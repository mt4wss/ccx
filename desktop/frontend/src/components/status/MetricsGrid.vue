...
<template>
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 select-none">
    <!-- 1. 网关运行端口 -->
    <div class="bg-glass dark:bg-glass-dark bg-glass-hover dark:bg-glass-hover-dark rounded-xl p-4.5 border border-border flex flex-col justify-between group">
    ...
    <div class="bg-glass dark:bg-glass-dark bg-glass-hover dark:bg-glass-hover-dark rounded-xl p-4.5 border border-border flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-muted-foreground uppercase">{{ t('metrics.version') }}</span>
